#this code will try to drive towards the object
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	#turn into HSV color space vary from 10-30 milliseconds
	hsv = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)

	# construct a mask for the color "green", then perform
	# a series of dilations and erosions to remove any small
	# blobs left in the mask used around 15 milliseconds
...
#			serialRokitMotor.servo1Increase()
		...
		elif y_coordinate > 290 and radius > 10:#(640, 480)
